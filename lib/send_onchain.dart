...
class SendOnChainPage extends StatefulWidget {
  @override
  _SendOnChainPageState createState() => _SendOnChainPageState();
}

class _SendOnChainPageState extends State<SendOnChainPage> {
      ...
      body: Padding(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Paste in your Solana wallet address and specify the amount of ZARP to send on-chain. Only Solana addresses are supported.',
