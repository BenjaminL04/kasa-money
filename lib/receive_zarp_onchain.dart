...
class ReceiveZarpOnchainPage extends StatefulWidget {
  @override
  _ReceiveZarpOnchainPageState createState() => _ReceiveZarpOnchainPageState();
}

class _ReceiveZarpOnchainPageState extends State<ReceiveZarpOnchainPage> {
  String pubkey = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Receive ZARP On-Chain', style: TextStyle(color: Colors.white)),
      ),
      body: Center(
        child: Column(
